 ...
 * 
 * Short Answer
 * 		3.3 You must use an == not an assignment operator
 * 		3.4 "apple"
 * 		3.5 "lime", "grape"
 * 		3.7 it produces even nubers from 2-20
 * 		3.8 it produces every other number from 0 to 200
 * 		3.9 it prodeuces every number from 200 to 0 that is not divisible by four
 * 		3.10 for (int num == 1; num < 20; num++)
 * 
 * AP
 *		3.1 D
 *		3.2 A
